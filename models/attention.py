...
def get_attention(attention='GSRA', channel=384, spatial=576):
    # 支持 None 或字符串 "none" 来禁用注意力模块
    if attention is None or (isinstance(attention, str) and attention.lower() == 'none'):
        ...
        print(f'Unknown attention type: {attention}, using Identity')
        return nn.Identity()
